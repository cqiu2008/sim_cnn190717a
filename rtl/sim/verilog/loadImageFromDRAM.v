...
input  [31:0] cnn_iPara_memAddrImgIn_V_read;
...
reg  signed [31:0] i_op_assign_s_reg_144;
reg  signed [31:0] i_op_assign_s_reg_144_pp0_iter1_reg;
wire    ap_block_state9_pp0_stage0_iter0;
reg    ap_block_state10_pp0_stage0_iter1;
wire    ap_block_state11_pp0_stage0_iter2;
wire    ap_block_state12_pp0_stage0_iter3;
reg    ap_block_pp0_stage0_11001;
wire  signed [31:0] lineWidthDiv16_cast_fu_165_p1;
reg  signed [31:0] lineWidthDiv16_cast_reg_269;
wire   [32:0] sum_fu_218_p2;
reg   [32:0] sum_reg_278;
wire   [0:0] or_cond3_fu_201_p2;
reg    ap_sig_ioackin_m_axi_fiddr_V_ARREADY;
wire   [0:0] exitcond_fu_234_p2;
reg   [0:0] exitcond_reg_289_pp0_iter1_reg;
wire   [31:0] i_fu_239_p2;
reg   [31:0] i_reg_293;
reg    ap_enable_reg_pp0_iter0;
reg   [127:0] fiddr_V_addr_read_reg_298;
wire    ap_CS_fsm_state8;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state9;
reg    ap_enable_reg_pp0_iter2;
reg    ap_enable_reg_pp0_iter3;
reg  signed [31:0] ap_phi_mux_i_op_assign_s_phi_fu_148_p4;
reg   [15:0] ibufIndex_write_assi_reg_156;
wire    ap_CS_fsm_state13;
wire  signed [63:0] tmp_224_fu_245_p1;
wire   [63:0] sum_cast_fu_224_p1;
reg    ap_reg_ioackin_m_axi_fiddr_V_ARREADY;
wire   [0:0] slt_fu_177_p2;
wire   [0:0] tmp_1629_fu_169_p3;
wire   [0:0] tmp_s_fu_189_p2;
wire   [0:0] tmp1_fu_195_p2;
wire   [0:0] rev10_fu_183_p2;
wire  signed [31:0] grp_fu_250_p3;
wire   [32:0] tmp_332_cast_fu_211_p1;
wire   [32:0] sext_cast_fu_214_p1;
...
cnna_mac_muladd_16ns_26s_32ns_32_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 16 ),
    .din1_WIDTH( 26 ),
    .din2_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
cnna_mac_muladd_16ns_26s_32ns_32_1_1_U56(
    .din0(grp_fu_250_p0),
    .din1(lineWidthDiv16),
    .din2(cnn_iPara_memAddrImgIn_V_read),
    .dout(grp_fu_250_p3)
);
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_CS_fsm_state14)) begin
            ap_return_preg <= ibufIndex_write_assi_reg_156;
        end
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond_reg_289 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        i_op_assign_s_reg_144 <= i_reg_293;
    end else if ((1'b1 == ap_CS_fsm_state8)) begin
        i_op_assign_s_reg_144 <= 32'd0;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state13)) begin
        ibufIndex_write_assi_reg_156 <= hIndex;
    end else if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1) & (or_cond3_fu_201_p2 == 1'd1))) begin
        ibufIndex_write_assi_reg_156 <= ibufIndex_read_2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        exitcond_reg_289 <= exitcond_fu_234_p2;
        exitcond_reg_289_pp0_iter1_reg <= exitcond_reg_289;
        i_op_assign_s_reg_144_pp0_iter1_reg <= i_op_assign_s_reg_144;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond_reg_289 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        fiddr_V_addr_read_reg_298 <= m_axi_fiddr_V_RDATA;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        i_reg_293 <= i_fu_239_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        lineWidthDiv16_cast_reg_269 <= lineWidthDiv16_cast_fu_165_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((or_cond3_fu_201_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        sum_reg_278 <= sum_fu_218_p2;
    end
end

always @ (*) begin
    if ((exitcond_fu_234_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((exitcond_reg_289 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0))) begin
        ap_phi_mux_i_op_assign_s_phi_fu_148_p4 = i_reg_293;
    end else begin
        ap_phi_mux_i_op_assign_s_phi_fu_148_p4 = i_op_assign_s_reg_144;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state14)) begin
        ap_return = ibufIndex_write_assi_reg_156;
    end else begin
...
always @ (*) begin
    if (((exitcond_reg_289_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ibuf_V_we0 = 1'b1;
    end else begin
        ibuf_V_we0 = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ap_ST_fsm_state1 : begin
            if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1) & (or_cond3_fu_201_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state14;
            end else if (((or_cond3_fu_201_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (exitcond_fu_234_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((ap_enable_reg_pp0_iter3 == 1'b1) & (ap_enable_reg_pp0_iter2 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter3 == 1'b1) & (ap_enable_reg_pp0_iter2 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone)) | ((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (exitcond_fu_234_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((exitcond_reg_289 == 1'd0) & (m_axi_fiddr_V_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((exitcond_reg_289 == 1'd0) & (m_axi_fiddr_V_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_state10_pp0_stage0_iter1 = ((exitcond_reg_289 == 1'd0) & (m_axi_fiddr_V_RVALID == 1'b0));
end
...
assign exitcond_fu_234_p2 = ((ap_phi_mux_i_op_assign_s_phi_fu_148_p4 == lineWidthDiv16_cast_reg_269) ? 1'b1 : 1'b0);

assign grp_fu_250_p0 = grp_fu_250_p00;

assign grp_fu_250_p00 = hIndex;

assign i_fu_239_p2 = ($signed(ap_phi_mux_i_op_assign_s_phi_fu_148_p4) + $signed(32'd1));

assign ibuf_V_address0 = tmp_224_fu_245_p1;

assign ibuf_V_d0 = fiddr_V_addr_read_reg_298;

assign lineWidthDiv16_cast_fu_165_p1 = $signed(lineWidthDiv16);

assign m_axi_fiddr_V_ARADDR = sum_cast_fu_224_p1;
...
assign m_axi_fiddr_V_ARLEN = lineWidthDiv16_cast_reg_269;
...
assign or_cond3_fu_201_p2 = (tmp1_fu_195_p2 | rev10_fu_183_p2);

assign rev10_fu_183_p2 = (slt_fu_177_p2 ^ 1'd1);

assign sext_cast_fu_214_p1 = fiddr_V_offset;

assign slt_fu_177_p2 = (($signed(hIndex) < $signed(cnn_iPara_height_read)) ? 1'b1 : 1'b0);

assign sum_cast_fu_224_p1 = sum_reg_278;

assign sum_fu_218_p2 = (tmp_332_cast_fu_211_p1 + sext_cast_fu_214_p1);

assign tmp1_fu_195_p2 = (tmp_s_fu_189_p2 | tmp_1629_fu_169_p3);

assign tmp_1629_fu_169_p3 = hIndex[32'd15];

assign tmp_224_fu_245_p1 = i_op_assign_s_reg_144_pp0_iter1_reg;

assign tmp_332_cast_fu_211_p1 = $unsigned(grp_fu_250_p3);

assign tmp_s_fu_189_p2 = ((ibufIndex_read == hIndex) ? 1'b1 : 1'b0);
