...
input  [31:0] cnn_wParaNext_memAddrBias_V_read;
...
reg   [9:0] t_V_reg_146;
reg   [9:0] tmp_397_cast_reg_237;
wire   [32:0] sum_fu_185_p2;
reg   [32:0] sum_reg_244;
reg    ap_sig_ioackin_m_axi_SHARED_DRAM_V_ARREADY;
wire   [0:0] exitcond1_fu_205_p2;
reg   [0:0] exitcond1_reg_260_pp0_iter1_reg;
wire   [9:0] i_fu_210_p2;
reg   [9:0] i_reg_264;
reg    ap_enable_reg_pp0_iter0;
reg   [127:0] SHARED_DRAM_V_addr_r_2_reg_269;
wire   [0:0] exitcond_fu_221_p2;
reg   [0:0] exitcond_reg_274;
...
wire   [63:0] tmp_230_fu_232_p1;
reg   [63:0] tmp_230_reg_283;
...
wire   [13:0] ret_V_66_tr_fu_161_p2;
wire   [32:0] sext_cast_fu_181_p1;
wire   [32:0] tmp_333_cast_fu_177_p1;
...
always @ (posedge ap_clk) begin
    if (((exitcond1_reg_260 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        t_V_reg_146 <= 10'd0;
    end else if (((exitcond_fu_221_p2 == 1'd0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        t_V_reg_146 <= dramAddr_V_fu_226_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond1_reg_260 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        SHARED_DRAM_V_addr_r_2_reg_269 <= m_axi_SHARED_DRAM_V_RDATA;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        exitcond1_reg_260 <= exitcond1_fu_205_p2;
        exitcond1_reg_260_pp0_iter1_reg <= exitcond1_reg_260;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        exitcond_reg_274 <= exitcond_fu_221_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        ...
        tmp_397_cast_reg_237 <= {{ret_V_66_tr_fu_161_p2[13:4]}};
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond_fu_221_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        tmp_230_reg_283[9 : 0] <= tmp_230_fu_232_p1[9 : 0];
    end
end
...
always @ (*) begin
    if (((exitcond1_reg_260 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if ((exitcond1_fu_205_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((exitcond_reg_274 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        bbuf0_V_we0 = 1'b1;
    end else begin
        bbuf0_V_we0 = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        wbufTmp_V_address0 = tmp_230_fu_232_p1;
...
always @ (*) begin
    if (((exitcond1_reg_260_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        wbufTmp_V_we0 = 1'b1;
    end else begin
        wbufTmp_V_we0 = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (exitcond1_fu_205_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter2 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter2 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b0)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (exitcond1_fu_205_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
        ...
        ap_ST_fsm_pp1_stage0 : begin
            if (~((1'b0 == ap_block_pp1_stage0_subdone) & (ap_enable_reg_pp1_iter0 == 1'b1) & (exitcond_fu_221_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_pp1_stage0;
            end else if (((1'b0 == ap_block_pp1_stage0_subdone) & (ap_enable_reg_pp1_iter0 == 1'b1) & (exitcond_fu_221_p2 == 1'd1))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((exitcond1_reg_260 == 1'd0) & (m_axi_SHARED_DRAM_V_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((exitcond1_reg_260 == 1'd0) & (m_axi_SHARED_DRAM_V_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
always @ (*) begin
    ap_block_state10_pp0_stage0_iter1 = ((exitcond1_reg_260 == 1'd0) & (m_axi_SHARED_DRAM_V_RVALID == 1'b0));
end
...
assign bbuf0_V_address0 = tmp_230_reg_283;

assign bbuf0_V_d0 = wbufTmp_V_q0;

assign dramAddr_V_fu_226_p2 = (t_V_reg_146 + 10'd1);

assign exitcond1_fu_205_p2 = ((ap_phi_mux_i_op_assign_phi_fu_138_p4 == tmp_397_cast_reg_237) ? 1'b1 : 1'b0);

assign exitcond_fu_221_p2 = ((t_V_reg_146 == tmp_397_cast_reg_237) ? 1'b1 : 1'b0);
...
assign m_axi_SHARED_DRAM_V_ARLEN = tmp_397_cast_reg_237;
...
assign ret_V_66_tr_fu_161_p2 = (lhs_V_cast_fu_157_p1 + 14'd15);

assign sext_cast_fu_181_p1 = SHARED_DRAM_V_offset;

assign sum_cast_fu_191_p1 = sum_reg_244;

assign sum_fu_185_p2 = (sext_cast_fu_181_p1 + tmp_333_cast_fu_177_p1);

assign tmp_230_fu_232_p1 = t_V_reg_146;

assign tmp_333_cast_fu_177_p1 = cnn_wParaNext_memAddrBias_V_read;

assign tmp_s_fu_216_p1 = i_op_assign_reg_134_pp0_iter1_reg;

assign wbufTmp_V_d0 = SHARED_DRAM_V_addr_r_2_reg_269;

always @ (posedge ap_clk) begin
    tmp_230_reg_283[63:10] <= 54'b000000000000000000000000000000000000000000000000000000;
end
